...
Este repositório contém a base normativa para o desenvolvimento do Dealer Smart, um SaaS automotivo multitenant apoiado por Supabase.
...
6. [`docs/ROADMAP.md`](docs/ROADMAP.md) — decomposição obrigatória das entregas.
7. [`docs/REFERENCE_AUDIT.md`](docs/REFERENCE_AUDIT.md) — análise das referências históricas do Stitch.
